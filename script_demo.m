...
path1 = getenv('PATH');
path1 = [path1 ':/home/gpuuser/acv/tdd' ':/home/gpuuser/acv/improved_trajectory/release' ':/home/gpuuser/acv/dense_flow/release'];
setenv('PATH', path1);
getenv('PATH')
...
system(['../improved_trajectory/release/DenseTrackStab -f ',vid_name,' -o ',vid_name(1:end-4),'.bin']);

% TVL1 flow extraction
display('Extract TVL1 optical flow field...');
mkdir test/
system(['../dense_flow/release/denseFlow_gpu -f ',vid_name,' -x test/flow_x -y test/flow_y -b 20 -t 1 -d 3']);
...
% Spatial TDD
addpath /home/gpuuser/acv/caffe/matlab
